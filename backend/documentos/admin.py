...
class DocumentAdmin(admin.ModelAdmin):
    # ADICIONADO 'ocr_processed', 'ocr_confidence'
    list_display = [
        'title', 'patient', 'category', 'document_type', 
        'file_size_formatted', 'access_level', 'uploaded_by', 
        'ocr_processed', 'ocr_confidence', 'created_at'
    ]
    ...
    # ADICIONADO 'ocr_text', 'ocr_confidence', 'ocr_processed'
    readonly_fields = [
    ...
    fieldsets = (
        ...
        ('Processamento OCR', {
            'fields': ('ocr_processed', 'ocr_confidence', 'ocr_text')
        }),
